...
while {alive _unit} do {
	...
	if (!alive _unit OR captive _unit OR _exit OR !(vehicle _unit == _unit) OR (lifestate _unit =="INCAPACITATED") OR isplayer _unit OR (isplayer (_unit getvariable ["bis_fnc_moduleremotecontrol_owner",objNull]))) exitwith {
